...
import { Container, FormWrap, Logo, LogoWrap } from './ContactElements';



 const ContactElemnts = () => {
    const form = useRef();
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg" >
                                ...
                                <div class="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                                    ...
                                    <div class="ml-4 text-md tracking-wide font-semibold w-40">
                                         anchor.media.services@gmail.com
                                    </div>
                                </div>
                            </div>
                            <form class="p-6 flex flex-col justify-center" ref={form}  onSubmit={sendEmail}>
                                ...
                                <input type="submit" class="md:w-32 bg-red-600 hover:bg-red-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-red-500 transition ease-in-out duration-300" style={{backgroundColor:"#2d6a4f", cursor:"pointer"}}
                                Submit />
                            </form>
                        </div>
                    </div>
